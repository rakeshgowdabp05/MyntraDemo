...
public class UpdateAddressServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            addressService.updateAddress(userId, buildAddress(request));
            request.getSession().setAttribute(AttributeConstants.SUCCESS_MESSAGE, "Address updated successfully.");
    ...
    private CartAddressDto buildAddress(HttpServletRequest request) {
        ...
        address.setAddressId(parseLong(request.getParameter("addressId")));
